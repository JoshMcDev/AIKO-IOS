...
public final class ConfidenceBasedAutoFillEngine: @unchecked Sendable {
    ...
    // Metrics tracking
    private var _metrics: AutoFillMetrics = AutoFillMetrics()
    ...
    private func isRecentlyUsedField(_ field: RequirementField) -> Bool {
...
extension ConfidenceBasedAutoFillEngine {
    ...
    public func generateAutoFillExplanation(_ result: AutoFillResult) -> String {
    ...
    public func getConfidenceColor(for confidence: Float) -> Color {
        switch confidence {
        case 0.9...:
            return .green
        case 0.8..<0.9:
    ...
    public func getConfidenceDescription(for confidence: Float) -> String {
        switch confidence {
        case 0.9...:
            return "Very High"
        case 0.8..<0.9:
