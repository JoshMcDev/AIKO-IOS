...
final class DataTransformationService {
    ...
    private func transformForSF18(_ data: [String: Any], templateType: DocumentType) throws -> [String: Any] {
        var result = data
    ...
    private func transformForSF30(_ data: [String: Any], templateType: DocumentType) throws -> [String: Any] {
        var result = data
    ...
    private func transformForSF44(_ data: [String: Any], templateType: DocumentType) throws -> [String: Any] {
        var result = data
...
enum DataTransformationError: LocalizedError {
    ...
    var errorDescription: String? {
        switch self {
        case .thresholdExceeded(let message):
            return "Threshold exceeded: \(message)"
