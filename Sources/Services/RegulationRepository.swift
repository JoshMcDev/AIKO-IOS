...
public enum RegulationType: String, Equatable, CaseIterable {
    ...
    public var githubRepository: String {
        switch self {
        case .FAR:
            return "https://github.com/GSA/GSA-Acquisition-FAR"
        case .DFARS:
            return "https://github.com/GSA/GSA-Acquisition-DFARS"
        case .VAAR:
            return "https://github.com/GSA/GSA-Acquisition-VAAR"
        case .HHSAR:
            return "https://github.com/GSA/GSA-Acquisition-HHSAR"
        case .AGAR:
            return "https://github.com/GSA/GSA-Acquisition-AGAR"
        case .GSAM:
            return "https://github.com/GSA/GSA-Acquisition-GSAM"
        case .NASA_FAR, .NFS:
            return "https://github.com/GSA/GSA-Acquisition-NFS"
        case .DOSAR:
            return "https://github.com/GSA/GSA-Acquisition-DOSAR"
        case .AIDAR:
            return "https://github.com/GSA/GSA-Acquisition-AIDAR"
        case .DTAR:
            return "https://github.com/GSA/GSA-Acquisition-DTAR"
        case .DEAR:
            return "https://github.com/GSA/GSA-Acquisition-DEAR"
        case .DOLAR:
            return "https://github.com/GSA/GSA-Acquisition-DOLAR"
        case .HUDAR:
            return "https://github.com/GSA/GSA-Acquisition-HUDAR"
        case .CAR:
            return "https://github.com/GSA/GSA-Acquisition-CAR"
        case .EPAAR:
            return "https://github.com/GSA/GSA-Acquisition-EPAAR"
        case .TAR:
            return "https://github.com/GSA/GSA-Acquisition-TAR"
        default:
            return "" // Some don't have dedicated repos yet
        }
    }
}
...
extension RegulationRepository {
    public static func regulationsForAgency(_ agency: String) -> [RegulationType] {
...
extension RegulationRepository: DependencyKey {
    public static var liveValue: RegulationRepository {
        RegulationRepository(
            ...
            searchRegulations: { query, regulationSet in
...
extension DependencyValues {
    public var regulationRepository: RegulationRepository {
