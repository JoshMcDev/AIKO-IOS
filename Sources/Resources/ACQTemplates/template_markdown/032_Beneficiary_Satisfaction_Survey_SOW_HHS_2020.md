...
HPE DL360 GEN10 8SFF DP/USB/ODD
## BLNK KIT
...
HPE FLEXFBRC 10GB 4P 536FLR-T
## ADPTR
HPE 1.83M 10A C13-UL DOM PWR CORD
...
## CTRLR
HPE ETHERNET 1GB 4P 331FLR ADPTR
...
HPE 1U GEN10 SFF EASY INSTALL RAIL
## KIT
HPE 800W FS PLAT HT PLG LH PWR
## SPLY KIT
HPE DL360 GEN10 HIGH PERF FAN KIT
...
HPE ISS PRICE BAND 2 CDMR SERVICE
...
MicroSDHC PRO Endurance Memory
Card w/ Adapter 32GB
Virtual Tech Control Forward Only
...
PowerEdge VRTX Chassis Configure to
Order (468-0891)
PowerEdge M640 Server (210-ALYK)
...
SFP+ 10Gb multimode or single mode fiber
adapters
Fiber cables
...
4 Point Type 1 rack mount kit New
...
Nexus 9300 with 48p 10G-T, 6p 100G
QSFP28
...
Exhaus
Power Cord, 125VAC 13A NEMA 5-15 Plug,
North America
Nexus 9500, 9300, 3000 Base NX-OS
Software Rel 9.3.3
Cisco network cable - 10 ft (Switch to SAN
Cable)
...
Nexus Fan, 30CFM, port side exhaust
airflow
...
HP MSA 2050 Energy Star SFF Chassis
...
MSA 2050 SAN Controller - (1Gb/10GbE
iSCSI)
Power Supplies
...
HPE MSA 2.4TB 12G SAS 10K 2.5IN 512E
HDD 3yr Warranty Hard Drive
...
MSA and Disk Enclosure Support
...
OEM PowerEdge R640 XL Server (210 ALXZ)
Upper Enclave Only
...
Precision 7920 XL Tower XCTO Base (210AMRP)
Precision 7820 XL Tower XCTO Base (210AMWV)
...
Mobile Precision Workstation 7760 CTOG
(210-AYYG)
TP-Link Gigabit Adapter
...
1TB 7.2K RPM SATA 6Gbps 512n Hot-Plug
Hard Drive with Carrier
...
Tripp Lite 8-Port Rack Console KVM Switch
19" LCD PS2/USB Cables
...
HP Mounting Bracket for Monitors
...
HP t740 Thin Pro, with AMD Ryzen Quad
Core, 128GF, 8GR, AMD Ryzen e9173
...
Tripp Lite USB 3.0 to SATA Hard Drive Flat
Quick Dock 2.5in 3.5in HDD SSD
...
BUFFALO MediaStation™ 16x External
BDXL Blu-ray Burner
Target Systems (jhost, vCenter)
...
U.S. Federal VMware vSphere 6 with
Operations Management Enterprise Plus for
1
processor
VMware Inc. - VS6-OEPL-F
...
VMware vSphere 6 with Operations
Management Enterprise Plus for 1 year
VMware Inc. - VS6-OEPL-P-SSS-F
...
U.S. Federal VMware vCenter Server 6
Standard for vSphere 6 (Per Instance)
VMware Inc. - VCS6-STD-F
...
U.S. Federal Production
Support/Subscription
VMware vCenter Server 6 Standard for
vSphere 6 (Per Instance) for 1 year
VMware Inc. - VCS6-STD-P-SSS-F
...
Target Systems (WARSIM)

LICENSE

Processor and Annual Support (Database)
...
HP 42U 600mm x 1075mm Standard Pallet
Rack
HP 42U Standard Series Rack Side Panel
Ki
HP 42U Standard Series Rack Grounding
Ki
HP Rack Cable Management Ki
...
HP 4.9kVA 208 Volt 20 Outlet NA/JP Basic
Power Distribution Uni
HP 1U 10-pack Black Universal Filler Panel
...
(Mobile Suites Only)1

3SKBR904U30
3SKB-SA

30" Deep 4U Roto Shock Rack
...
Mobile Racks (Mobile Suites Only)

DE2430TSA2276
DE2414TSA2274
UPS #1

Pelican Hardigg 14U Mobile Case/Rack
...
Pelican Hardigg 6U Mobile Case/Rack
...
HP R/T2200 Uninterruptible Power System
(UPS)
2U R/T UPS ERM Shipping Ki
...
2200 Watt (L5-20P option)

1For sites requiring a Mobile solution, replace the Fixed Rack with the 6 Mobile 4 RU Transit
...
The table below maps the various virtualized solutions for JLCCTC with the applicable enclaves.
JLCCTC Virtualized Solution
## JLCCTC BDE SE
## JLCCTC BDE SE MOBILE
## JLCCTC BDE DE
## JLCCTC DIV
## JLCCTC VTCF
## JLCCTC SVS
...
Applicable Enclaves
JLCCTC Brigade Lower Enclave
JLCCTC Brigade Lower Enclave Mobile
JLCCTC Brigade Lower Enclave & JLCCTC UE
JLCCTC DIV LE, JLCCTC ME, & JLCCTC UE
JLCCTC Virtual Technical Control Forward Lower
Enclave
JLCCTC Sustainment Virtual Suite
JLCCTC Stand Alone System

What follows is a system diagram for JLCCTC (i.e. JLCCTC BDE Single Enclave (SE), JLCCTC BDE
Single Enclave Mobile (SE Mobile), JLCCTC BDE Dual Enclave (DE), JLCCTC Division (DIV), JLCCTC
Virtual Tech Control Forward (VTCF), and JLCCTC Sustainment Virtual Suite (SVS). There is a Common
Hardware Platform (CHP) based JLCCTC Stand Alone System (SAS).
Details of the system layout diagram per enclave is addressed in the appropriate TO(s).
...
Virtualized JLCCTC Upper Enclave
Server Stack*
...
Security Server Terrain Repo

UE Server Stack HW List
APC Net Shelter 42RU Rack
HPE MSA 2040 or 2050 - SAN
HPE DL360 Gen 9 or 10 - jHost 1 & 2
HPE DL360 Gen10 - jHost 3
Dell R640 – Rialto
Dell R740 – Radiant Mercury
Nexus 3172 - Switch
TRIPP PDU x2
HPE R/T2200 UPS x1
...
Virtual Components: RTI JLCCTC, INTEL Model, Land Model, RTI Gateway, Object Owner, Data Processor,
Data Collector, Jcontrol, Exercise Data Server, Cluster Gateway, Remote Gateway, NFS, Parametric Data
Controller, Clone Server, Vcenter Server Appliance, Domain Controller/Active Directory, Database WARSIM –
WIM, MC Gateway

Lighter Orange – New VMs

Orange – New JLCCTC v9.0 HW Black – Reuse of existing HW
...
Virtualized JLCCTC Middle Enclave
Server Stack
...
Terrain Repo Master Console

Virtual Components: INTEL Model, RTI Gateway, Object Owner, Data Processor, Data Collector,
MC Gateway, MC Adapter, Jcontrol, Exercise Data Server, Cluster Gateway, Remote Gateway, NFS,
Parametric Data Controller, Clone Server, Vcenter Server Appliance, Domain Controller/Active
Directory, Database – WARSIM
Lighter Green – New VMs
Green – New JLCCTC v9.0 HW
...
Virtualized JLCCTC Tech Control Forward
...
JHOST 1 & 2/Dell M640 Blade
JHOST 3/Dell M640 Blade
...
Master Console/Dell R340
Dell VRTX
(Server Chassis, Storage,
and Network)
...
VMs: Network File Server, Remote Gateway, JCONTROL, Clone Server, Domain JCUI Client &
Controller/Active Directory, JCUI Webserver, Listello, Local Database –
Perspective
Sustainment, Local Sim Data Server, Local jCUI Web Server, Vcenter Server
Clien
Appliance
Server Stack HW Lis
Rack
HPE MSA 2050 - SAN
HPE DL360 Gen10 - jHost 1 - 2
Nexus 3172 – Switch x 1
Rack Mount KVM - 8port x 1
TRIPP PDU x 2
HPE R/T2200 UPS x 2
Dell R340 Config 1
