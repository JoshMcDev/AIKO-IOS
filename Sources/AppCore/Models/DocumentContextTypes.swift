...
public struct ComprehensiveDocumentContext: Equatable, Sendable {
...
public struct APELineItem: Equatable, Sendable {
...
public struct AdaptiveExtractionResult: Equatable, Sendable {
    public let confidence: Double
...
public struct ValueObject: Equatable, Sendable {
