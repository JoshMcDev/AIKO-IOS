...
struct SAMReportPreview: View {
    ...
    let acquisitionValue: Double = 150000 // Example value under SAT
    ...
    var body: some View {
                        ...
                        */
                        ...
                        HStack {
                            ...
                            Text("Auto send")
                                ...
                                .foregroundColor(.gray)
                            Spacer()
                            Text(acquisitionValue <= 250000 ? "UnderSATBot" : "OverSATBot")
                                .font(.caption)
                                .foregroundColor(.gray)
                        }
                        .padding()
        ...
        .alert("SAT Bot", isPresented: $showingSATBotAlert) {
            ...
            if MFMailComposeViewController.canSendMail() {
                Text("Email queued for \(acquisitionValue <= 250000 ? "UnderSATBot" : "OverSATBot") with UEI: R7TBP9D4VNJ3")
            } else {
    ...
    private func sendSATBotEmailInBackground() {
        ...
        if MFMailComposeViewController.canSendMail() {
            ...
            _ = acquisitionValue <= 250000 ? "UnderSATBot@outlook.com" : "OverSATBot@outlook.com"
            ...
            #if os(iOS)
            let recipient = acquisitionValue <= 250000 ? "UnderSATBot@outlook.com" : "OverSATBot@outlook.com"
