...
public struct UserGuideView: View {
    ...
    enum GuideSection: String, CaseIterable {
        ...
        var icon: String {
            ...
            case .creatingDocuments: return "doc.badge.plus"
            case .understandingDocuments: return "doc.text.magnifyingglass"
            case .usingAI: return "brain"
            case .managingProfile: return "person.crop.circle"
