...
public struct ApprovalRequestView: View {
    ...
    private var impactDescription: String {
        ...
        case .low:
            return "Low impact • Easily reversible"
        case .medium:
            return "Medium impact • Some consequences"
        case .high:
            return "High impact • Significant consequences"
        }
    }
    ...
    private var approveButtonColor: Color {
        ...
        case .medium:
            return .orange
        case .high:
            return Theme.Colors.aikoAccent
        }
    }
...
struct ActionDetailsView: View {
    ...
    private var expectedOutcome: String {
        switch action.type {
        case .gatherMarketResearch:
            return "Will search multiple databases and compile market analysis report with pricing trends and vendor capabilities"
        case .generateDocuments:
            return "Will create all required acquisition documents based on gathered requirements"
        case .identifyVendors:
            return "Will search SAM.gov and other databases to find qualified vendors"
        case .scheduleReviews:
            return "Will coordinate with stakeholders and schedule review meetings"
        case .submitForApproval:
            return "Will submit the acquisition package through the approval workflow"
        case .monitorCompliance:
            return "Will continuously monitor compliance status and alert on any issues"
        }
    }
}