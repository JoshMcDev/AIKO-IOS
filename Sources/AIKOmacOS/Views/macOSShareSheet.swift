...
public struct macOSShareSheet: NSViewControllerRepresentable {
    ...
    public func makeNSViewController(context: Context) -> ShareViewController {
    ...
    public func updateNSViewController(_ nsViewController: ShareViewController, context: Context) {}
}
