...
public struct macOSImagePicker: NSViewControllerRepresentable {
    ...
    public func makeNSViewController(context: Context) -> ImagePickerViewController {
    ...
    public func updateNSViewController(_ nsViewController: ImagePickerViewController, context: Context) {}
}
...
public struct macOSImageCapture: NSViewControllerRepresentable {
    ...
    public func makeNSViewController(context: Context) -> ImageCaptureViewController {
    ...
    public func updateNSViewController(_ nsViewController: ImageCaptureViewController, context: Context) {}
}
