...
public protocol DomainEventStore {
    ...
    func eventsOfType<T: DomainEvent>(_ type: T.Type, after: Date?) async throws -> [StoredDomainEvent]
...
public final class CoreDataEventStore: DomainEventStore {
    ...
    public func eventsOfType<T: DomainEvent>(_ type: T.Type, after: Date?) async throws -> [StoredDomainEvent] {
        let context = container.newBackgroundContext()
    ...
    private func encodeEvent<T: Codable>(_ event: T, mirror: Mirror) throws -> Data {
    ...
    private func mapToStoredEvent(_ managedObject: NSManagedObject) throws -> StoredDomainEvent {
        guard let id = managedObject.value(forKey: "id") as? UUID,
              ...
              let version = managedObject.value(forKey: "version") as? Int else {
