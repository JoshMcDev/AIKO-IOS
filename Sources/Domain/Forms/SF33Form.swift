...
public final class SF33Factory: BaseFormFactory<SF33Form> {
    override public func createBlank() -> SF33Form {
    ...
    override public func createForm(with data: FormData) throws -> SF33Form {
    ...
    private func createOfferSection(from fields: [String: Any]) throws -> OfferSection {
        ...
        let offeror = try OfferSection.OfferorInfo(
            ...
            email: Email(fields["email"] as? String ?? "placeholder@example.com"),
    ...
    private func createAwardSection(from _: [String: Any]) throws -> AwardSection {
