...
public struct SF18DeliveryInformation: ValueObject {
    ...
    public func validate() throws {
        ...
        if let afterDate = afterDate, let beforeDate = beforeDate {
...
public final class SF18Factory: BaseFormFactory<SF18Form> {
    ...
    public override func createBlank() -> SF18Form {
    ...
    public override func createForm(with data: FormData) throws -> SF18Form {
    ...
    private func createItemsSection(from fields: [String: Any]) throws -> ItemsSection {
    ...
    private func createSolicitationInfo(from fields: [String: Any]) throws -> SolicitationInformation {
        ...
        let officer = SolicitationInformation.ContractingOfficerInfo(
