...
public actor CacheConnection {
    ...
    /// Set multiple values
    public func setMultiple<T: Codable>(_ values: [String: T], ttl: TimeInterval?) async throws {
...
public actor MockCacheConnection {
    ...
    public func exchangeNodeInfo(nodeId: String, endpoint: String) async throws -> [String: CacheConnection.NodeInfo] {
        // Mock implementation
        return [:]
    }
