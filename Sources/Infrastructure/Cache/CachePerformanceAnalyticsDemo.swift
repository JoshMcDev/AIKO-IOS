...
private func generateSimulatedEvents(count: Int) -> [CacheAccessEvent] {
    ...
    for i in 0..<count {
        ...
        let baseLatency: TimeInterval = {
            switch tier {
            case .l1Memory: return 0.001   // 1ms
            case .l2SSD: return 0.005      // 5ms
            case .l3Distributed: return 0.02 // 20ms
            case .l4CloudStorage: return 0.1 // 100ms
            }
        }()
...
public struct CachePerformanceAnalyticsDemoRunner {
