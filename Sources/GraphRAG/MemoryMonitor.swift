...
enum MemoryPressure: String, Sendable, CaseIterable {
    ...
    var description: String {
        ...
        case .moderate: return "Memory usage is elevated but manageable"
        case .high: return "Memory usage is high - consider freeing resources"
        case .critical: return "Memory usage is critical - immediate action required"
        }
    }
}