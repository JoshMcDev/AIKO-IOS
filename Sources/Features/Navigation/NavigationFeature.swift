...
public struct NavigationFeature {
    ...
    public struct State: Equatable {
        ...
        public init(
            ...
            self.navigationHistory = [currentView]
        }
    }
    ...
    public var body: some ReducerOf<Self> {
        Reduce { state, action in
            ...
            case .setTransitioning(let transitioning):
...
extension NavigationFeature.State {
    ...
    public var previousView: NavigationView? {
