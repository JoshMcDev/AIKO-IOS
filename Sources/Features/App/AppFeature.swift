...
public struct AppFeature {
    ...
    public enum MenuItem: String, CaseIterable, Equatable {
        ...
        public var icon: String {
            ...
            case .myAcquisitions: return "clock.arrow.circlepath"
            case .quickReferences: return "link.circle.fill"
            case .searchTemplates: return "doc.text.magnifyingglass"
            case .userGuide: return "questionmark.circle.fill"
        ...
        public var description: String {
            switch self {
            case .myProfile: return "Your profile information"
            case .myAcquisitions: return "View your requirement history"
            case .quickReferences: return "Access external resources"
            case .searchTemplates: return "Browse all document templates"
            case .userGuide: return "Learn how to use AIKO"
    ...
    public enum QuickReference: String, CaseIterable, Equatable {
        ...
        public var url: String {
            switch self {
            case .acquisitionGov: return "https://www.acquisition.gov/browse/index/far"
            case .samGov: return "https://sam.gov/"
            case .fpdsNG: return "https://www.fpds.gov/fpdsng_cms/index.php/en/"
        ...
        public var icon: String {
            switch self {
            case .acquisitionGov: return "book.circle.fill"
            case .samGov: return "building.columns.circle.fill"
            case .fpdsNG: return "chart.bar.doc.horizontal.fill"
            case .customLink: return "plus.circle.fill"
            }
        }
        
        public var description: String {
            switch self {
            case .acquisitionGov: return "Federal Acquisition Regulation"
            case .samGov: return "System for Award Management"
            case .fpdsNG: return "Federal Procurement Data System"
            case .customLink: return "Add your own reference link"
            }
        }
    }
    ...
    public var body: some ReducerOf<Self> {
        ...
        Reduce { state, action in
            ...
            case .toggleQuickReferences(let show):
                state.showingQuickReferences = show
                return .none
                
            case .selectQuickReference(let reference):
            ...
            case .showProfile(let show):
                state.showingProfile = show
                return .none
                
            case .showAcquisitions(let show):
                state.showingAcquisitions = show
                return .none
                
            case .showUserGuide(let show):
                state.showingUserGuide = show
                return .none
                
            case .showSearchTemplates(let show):
            ...
            case .documentGeneration(.needsMoreInfoForDocuments(let documentTypes)):
                ...
                let intent = AcquisitionIntent(
                    ...
                    parameters: ["documents": documentTypes.map { $0.shortName }.joined(separator: ", ")],
                    confidence: 0.95,
            ...
            case .acquisitionLoaded(let acquisition):
            ...
            case .loadAcquisitionError(let error):
            ...
            case .showDownloadOptions(let id):
            ...
            case .shareAcquisitionDocuments(let id):
            ...
            case .shareAcquisitionContractFiles(let id):
