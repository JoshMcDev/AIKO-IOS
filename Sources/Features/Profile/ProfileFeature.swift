    ...
    public var body: some ReducerOf<Self> {
        Reduce { state, action in
            ...
            case let .copyAddress(from: source, to: destination):
                ...
                switch source {
                case .administeredBy:
                    sourceAddress = state.profile.defaultAdministeredByAddress
                case .payment:
                    sourceAddress = state.profile.defaultPaymentAddress
                case .delivery:
                    sourceAddress = state.profile.defaultDeliveryAddress
                }
