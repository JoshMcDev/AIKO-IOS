...
public struct AuthenticationFeature {
    ...
    public var body: some ReducerOf<Self> {
        Reduce { state, action in
            ...
            case .setRequiresAuthentication(let required):
            ...
            case .biometricTypeDetected(let type):
    ...
    private func authenticationReason(for type: BiometricType) -> String {
        switch type {
        case .faceID:
            return "Use Face ID to access AIKO"
        case .touchID:
            return "Use Touch ID to access AIKO"
        case .opticID:
            return "Use Optic ID to access AIKO"
        case .none:
            return "Authenticate to access AIKO"
        }
    }
}
...
extension AuthenticationFeature.State {
    ...
    public func isAuthenticationFresh(now: Date = Date()) -> Bool {
