...
public struct OnboardingFeature {
    ...
    public struct State: Equatable {
        ...
        public enum Step: Int, CaseIterable {
            ...
            var title: String {
                switch self {
                case .welcome: return "Welcome to AIKO"
                case .personalInfo: return "Personal Information"
                case .contactInfo: return "Contact Information"
                case .organizationInfo: return "Organization"
                case .addresses: return "Default Addresses"
                case .apiKey: return "API Configuration"
            ...
            var subtitle: String {
                switch self {
                case .welcome: return "Let's set up your profile"
                case .personalInfo: return "Tell us about yourself"
                case .contactInfo: return "How can we reach you?"
                case .organizationInfo: return "Your organization details"
                case .addresses: return "Set your default addresses"
                case .apiKey: return "Configure your Anthropic API key"
                case .review: return "Review your information"
                }
            }
            
            var progress: Double {
                Double(self.rawValue + 1) / Double(Step.allCases.count)
            }
        }
