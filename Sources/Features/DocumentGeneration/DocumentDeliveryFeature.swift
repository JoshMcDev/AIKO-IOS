...
public struct DocumentDeliveryFeature {
    ...
    public enum EmailOption: CaseIterable, Equatable {
        ...
        public var title: String {
            switch self {
            case .profile: return "Use Profile Email"
            case .different: return "Different Email Address"
            case .noProfile: return "Enter Email Address"
            }
        }
    }
    ...
    public enum DeliveryOption: CaseIterable {
        ...
        public var icon: String {
            ...
            case .both: return "square.and.arrow.up"
            }
        }
    }
    ...
    public var body: some ReducerOf<Self> {
        Reduce { state, action in
            ...
            case .sendDocumentsViaEmail:
                ...
                switch state.selectedEmailOption {
                case .profile:
                    emailAddress = state.userProfileEmail
                case .different, .noProfile:
                    emailAddress = state.customEmailAddress
                }
