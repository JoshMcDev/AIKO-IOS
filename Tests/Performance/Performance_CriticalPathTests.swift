...
final class CriticalPathPerformanceTests: XCTestCase {
    ...
    private func performSAMSearch(for entity: String) async -> SAMSearchResult {
        ...
        return SAMSearchResult(
            entityName: entity,
            uei: "UEI\(Int.random(in: 100000...999999))",
    ...
    private func generateDocumentSuggestions(from response: String) async -> [String] {
    ...
    private func performShare(items: [Any], metadata: ShareMetadata) async -> ShareResult {
    ...
    private func performBiometricAuth(type: BiometricType) async -> AuthResult {
