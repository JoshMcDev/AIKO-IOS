...
@MainActor
final class Migration_TCAToSwiftUIValidationTests: XCTestCase {
    ...
    func test_migrationParity_actionsMappedToMethods() {
        ...
        let _ = modernViewModel.isProviderConfigSheetPresented
