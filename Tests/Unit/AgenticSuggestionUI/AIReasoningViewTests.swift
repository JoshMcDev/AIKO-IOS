...
final class AIReasoningViewTests: XCTestCase {
    ...
    var testDecisionResponse: AIKO.DecisionResponse?
    var testComplianceContext: AIReasoningTestComplianceContext?
    var mockComplianceGuardian: AIReasoningTestMockComplianceGuardian?
    ...
    override func setUp() async throws {
        ...
        mockComplianceGuardian = AIReasoningTestMockComplianceGuardian()
    ...
    private func createDecisionResponseWithSHAP() -> AIKO.DecisionResponse {
    ...
    private func createDecisionResponseWithFactors() -> AIKO.DecisionResponse {
        var decision = createTestDecisionResponse()
    ...
    private func createDecisionResponseWithAuditTrail() -> AIKO.DecisionResponse {
        var decision = createTestDecisionResponse()
    ...
    private func createDecisionResponseWithPrecedent() -> AIKO.DecisionResponse {
        var decision = createTestDecisionResponse()
    ...
    private func createComplexDecisionResponse() -> AIKO.DecisionResponse {
...
extension AIKO.DecisionResponse {
...
// MARK: - AIReasoningTest Mock Classes

class AIReasoningTestMockComplianceGuardian: Sendable {
