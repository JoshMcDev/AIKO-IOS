...
final class Unit_SAMGovRepositoryTests: XCTestCase {
    ...
    func testGetEntities_MultipleUEIs_Success() async throws {
        ...
        mockAPIClient.getEntitiesHandler = { uei in
            switch uei {
            case "TEST123456":
                return self.createMockEntity(name: "Company 1", uei: uei)
            case "TEST789012":
                return self.createMockEntity(name: "Company 2", uei: uei)
            case "TEST345678":
                return self.createMockEntity(name: "Company 3", uei: uei)
            default:
                return nil
            }
        }
