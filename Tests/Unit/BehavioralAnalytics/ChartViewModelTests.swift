...
final class ChartViewModelTests: XCTestCase {
    ...
    private func createMockTimeSeriesData(days: Int = 30, startDaysAgo: Int = 30) -> [ChartViewModelTests.ChartDataPoint] {
        (0..<days).map { day in
            ChartDataPoint(
    ...
    private func createMixedMetricTypeData() -> [ChartViewModelTests.ChartDataPoint] {
        var data: [ChartViewModelTests.ChartDataPoint] = []
