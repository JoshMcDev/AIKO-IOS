...
final class AcquisitionContextClassifierTests: XCTestCase {
    ...
    private func createTestAcquisition(
        ...
        AppCore.AcquisitionAggregate(
            ...
            requirements: requirements?.components(separatedBy: " ")
        )
    }
    ...
    private func createProfessionalServicesTestData() -> [AppCore.AcquisitionAggregate] {
        [
            AppCore.AcquisitionAggregate(
                ...
                description: "Comprehensive consulting with professional services and management support",
                requirements: ["Professional consulting services", "Advisory assistance", "Training programs"]
            ),
            AppCore.AcquisitionAggregate(
                title: "Professional Training and Advisory Services",
                description: "Professional training programs with consulting and maintenance support services",
                requirements: ["Training services", "Advisory assistance", "Professional development support"]
            ),
            AppCore.AcquisitionAggregate(
                title: "Operations Management Support",
                description: "Comprehensive management support with professional services and operations consulting",
                requirements: ["Professional operations management", "Advisory consulting services"]
            ),
        ]
    }
