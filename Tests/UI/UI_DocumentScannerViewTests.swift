...
@MainActor
final class UI_DocumentScannerViewTests: XCTestCase {
...
struct DocumentScannerView: View {
    ...
    init(viewModel: DocumentScannerViewModel = DocumentScannerViewModel()) {
...
extension View {
    func accessibilityLabel() throws -> String? {
        // Mock implementation for testing - will be replaced in GREEN phase
        return nil
    }
