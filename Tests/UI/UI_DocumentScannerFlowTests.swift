...
@MainActor
final class UI_DocumentScannerFlowTests: XCTestCase {
    ...
    func test_voiceOverNavigation_completeScanFlow() {
        ...
        XCTAssertEqual(scanButton.accessibilityHint, "Activates the camera to scan documents")
        ...
        XCTAssertEqual(captureButton.accessibilityHint, "Takes a photo of the document")
