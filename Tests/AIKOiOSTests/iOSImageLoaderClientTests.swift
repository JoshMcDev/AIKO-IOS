    ...
    final class iOSImageLoaderClientTests: XCTestCase {
        ...
        func testMainActorContextVerification() async {
            ...
            let image = await client.loadImage(from: testImageData)
        ...
        func testLoadImageFromDataMainActor() async {
            ...
            let image = await client.loadImageFromData(testImageData)
        ...
        func testCreateImageMainActor() async {
            ...
            let image = await client.createImage(from: platformImage)
        ...
        func testConvertToSwiftUIImageMainActor() async {
            ...
            let image = await client.convertToSwiftUIImage(platformImage)
        ...
        func testAsyncAwaitPattern() async {
            ...
            async let loadImageTask = client.loadImage(from: testImageData)
            async let createImageTask = client.createImage(from: platformImage)
            async let convertImageTask = client.convertToSwiftUIImage(platformImage)
        ...
        func testLoadImageFromInvalidData() async {
            ...
            let image = await client.loadImage(from: invalidData)
        ...
        func testLoadImageFromBundle() async {
            ...
            let image = await client.loadImageFromBundle(named: "nonexistent", withExtension: "png", in: Bundle.main)
        ...
        func testLoadImageFromNonExistentFile() async {
            ...
            let platformImage = await client.loadImageFromFile(nonExistentPath)
        ...
        func testEmptyPlatformImage() async {
            ...
            let image = await client.createImage(from: emptyPlatformImage)
